...
#try:
    ...
    #from graphpype.nodes.igraph_plots import PlotIGraphModules
...
def create_pipeline_nii_to_conmat_seg_template(main_path, pipeline_name = "nii_to_conmat",conf_interval_prob = 0.05, background_val = -1.0):
