...
def test_visu_graph_modules():
    ...
    """
    vb = visu_graph_modules(net_file=Pajek_net_file, lol_file=lol_file,
                            coords_file=coords_file, labels_file=labels_file)
...
def test_visu_graph():
    ...
    """
    vb = visu_graph(net_file = Pajek_net_file, coords_file = coords_file,
